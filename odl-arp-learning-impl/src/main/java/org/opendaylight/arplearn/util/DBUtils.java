...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.odl.calculator.api.api.rev170507.OdlArpApiBuilder;
...
public class DBUtils {
	...
	public static void store(DataBroker dataBroker, BigInteger dpnId, short ofport, String mac, String ip) {
		...
		MDSALUtil.syncWrite(dataBroker, LogicalDatastoreType.CONFIGURATION,
				...
				.child(IpToMac.class, new IpToMacKey(ip)).build()
				, dataObject);
	}
